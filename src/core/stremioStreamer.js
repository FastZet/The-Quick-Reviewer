...
const buildStreamTitle =
  typeof titleMod === "function"
    ? titleMod
    : (titleMod && typeof titleMod.buildStreamTitle === "function"
        ? titleMod.buildStreamTitle
        : (titleMod && typeof titleMod.default === "function"
            ? titleMod.default
            : null));
...
const BASE_URL = process.env.BASE_URL || process.env.HF_SPACE_URL || process.env.BASEURL || process.env.HFSPACEURL || null;
