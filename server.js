...
const manifest = {
    ...
    version: '13.0.0', // The Final Correct Version
...
builder.defineStreamHandler(async ({ type, id }) => {
    ...
    // THIS IS THE DEFINITIVE FIX. 'externalUrl' is the explicit instruction
    // to open the link in an external browser.
    const reviewStream = {
        name: "The Quick Reviewer",
        title: "⭐️ Click to Read AI Review",
        description: "A detailed, spoiler-free review generated by AI.",
...
app.listen(PORT, () => {
    console.log(`TQR Addon v13.0.0 (The Final Correct Version) listening on port ${PORT}`);
